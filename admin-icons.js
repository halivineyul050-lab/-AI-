(() => {
  ...
  const icons = {
    ...
    "archive": '<rect x="3" y="4" width="18" height="5" rx="1"/><path d="M5 9v10h14V9"/><path d="M9 13h6"/>',
    ...
    "file-text": '<path d="M6 2h8l4 4v16H6z"/><path d="M14 2v5h5"/><path d="M9 13h6"/><path d="M9 17h6"/>',
    "folder-tree": '<path d="M3 6h6l2 2h10v10H3z"/><path d="M8 12v3"/><path d="M8 15h7"/><path d="M15 13v4"/>',
    ...
    "image-off": '<path d="m3 3 18 18"/><path d="M6 4h13a2 2 0 0 1 2 2v11"/><path d="M18 20H5a2 2 0 0 1-2-2V7"/><path d="m8 15 2-2 2 2 2-2 4 4"/>',
    ...
    "layout-list": '<rect x="3" y="4" width="18" height="16" rx="2"/><path d="M8 8h9"/><path d="M8 12h9"/><path d="M8 16h9"/><path d="M5 8h.01"/><path d="M5 12h.01"/><path d="M5 16h.01"/>',
    ...
    "newspaper": '<path d="M5 4h14v16H5z"/><path d="M5 8H3v10a2 2 0 0 0 2 2"/><path d="M9 8h6"/><path d="M9 12h6"/><path d="M9 16h3"/>',
    ...
    "sparkles": '<path d="m12 3-1 3.5L7.5 8 11 9.5 12 13l1-3.5L16.5 8 13 6.5z"/><path d="m19 13-.7 2.3L16 16l2.3.7L19 19l.7-2.3L22 16l-2.3-.7z"/><path d="m5 14-.8 2.2L2 17l2.2.8L5 20l.8-2.2L8 17l-2.2-.8z"/>',
    "star": '<path d="m12 3 2.8 5.7 6.2.9-4.5 4.4 1.1 6.2-5.6-2.9-5.6 2.9 1.1-6.2L3 9.6l6.2-.9z"/>',
    "triangle-alert": '<path d="M12 3 2.5 20h19z"/><path d="M12 9v4"/><path d="M12 16h.01"/>',
    "trash-2": '<path d="M4 7h16"/><path d="M9 7V4h6v3"/><path d="m6 7 1 14h10l1-14"/><path d="M10 11v6"/><path d="M14 11v6"/>',
    "plug-zap": '<path d="m13 2-2 5h4l-2 5"/><path d="M6 12v3a6 6 0 0 0 12 0v-3"/><path d="M5 12h14"/><path d="M8 8v4"/><path d="M16 8v4"/>',
    ...
    "wrench": '<path d="M14.7 6.3a4 4 0 0 0-5-5l2.2 2.2-2.8 2.8L6.9 4.1a4 4 0 0 0 5 5L20 17.2a2 2 0 0 1-2.8 2.8l-8.1-8.1"/>',
